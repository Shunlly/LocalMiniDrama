...
// 从 videoClientPoll 拆出的轮询实现。取消/超时语义保持不变。
const {
  sanitizeProviderException,
  sanitizeProviderResult,
  summarizeProviderResponse,
} = require('../providerErrorSanitizer');
const { pollMinimaxVideo } = require('./minimaxVideoAdapter');
const { pollSoraVideo } = require('./openAiSoraAdapter');
const {
...
const { createAdapterRuntime } = require('./protocolDispatch');
const {
  resolveVideoPollFlags,
  buildVideoPollRequest,
  interpretVideoPollResponse,
} = require('./pollDispatch');
const {
