    ...
    <el-form-item label="本地素材文件">
      <div class="file-row">
        ...
        <ActionGate label="选择故事素材文件" :reason="sourceUploadBusyReason">
          <el-button size="small" :loading="sourceFileReading" :disabled="Boolean(sourceUploadBusyReason)" :title="sourceUploadBusyReason || undefined" :aria-label="sourceUploadBusyReason || '选择故事素材文件'" @click="sourceFileInput?.click()">选择故事素材文件</el-button>
        </ActionGate>
