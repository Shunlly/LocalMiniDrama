...
export function createFilmCreateSurfaceBindingSources(ctx = {}) {
  const {
    ...
    pipelinePaused, pipelineErrorLog, lastPipelineMode, pipelineCurrentStep, pipelineStepIndex,
  ...
  return {
    ...
    pipelinePanel: {
      ...
      running: pipelineRunning, paused: pipelinePaused, errorLog: pipelineErrorLog, lastPipelineMode,
