...
export function createFilmCreateWorkspaceBindingSources(ctx = {}) {
  const {
    ...
    onGenerateStoryboard, onInsertStoryboardBefore, onInsertStoryboardAfter, storyboardsAPI, storyboardReorderBusy,
  ...
  return {
    ...
    onGenerateSbImage, onGenerateSbVideo, onGenerateStoryboard, onInsertStoryboardBefore, onInsertStoryboardAfter, storyboardsAPI, storyboardReorderBusy, dropTargetStoryboardIndex, onMoveStoryboardUp, onMoveStoryboardDown, onReorderDragStart, onReorderDragOver, onReorderDragEnd, onReorderDrop,
