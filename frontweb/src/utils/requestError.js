...
const TECHNICAL_ENGLISH_RE = /network error|timeout of \d+ms|request failed with status code|err_network|econnaborted|etimedout|failed to fetch|fetch failed|load failed|internal server error|econnrefused|enotfound|econnreset|eai_again|socket hang up|getaddrinfo|und_err_|project_load_failed|\baborterror\b|\baborted\b|\btypeerror\b|\breferenceerror\b|the operation was aborted|this operation was aborted|the user aborted|\bcanceled\b|\bcancelled\b|invalid api key|incorrect api key|invalid authorization|unauthorized|this model does not support|image generation did not complete|video generation did not complete|model is overloaded|retry later|\blistassetgroups\b|\bcreateassetgroup\b|\bupdateassetgroup\b|\bdeleteassetgroup\b|\blistassets\b|\bcreateasset\b|\bupdateasset\b|\bdeleteasset\b|\bgetassetgroup\b|\bgetasset\b|\b(?:http\s*)?(?:401|403)\b/i
