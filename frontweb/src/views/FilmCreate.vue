...
} = useFilmCreateStoryboardActions({
...
const {
  ...
  unmountWorkspace,
    ...
    onGenerateSbImage, onGenerateSbVideo, onGenerateStoryboard, onInsertStoryboardBefore, onInsertStoryboardAfter,
