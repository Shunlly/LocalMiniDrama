...
const workflowSources = readSourceIntakeWorkflowSources()
const intakeFormSource = readFileSync(new URL('../src/components/sourceIntake/SourceIntakeIntakeStageForm.vue', import.meta.url), 'utf8')
...
test('DramaDetail forwards source URL intent and the workflow applies it after loading completed state', () => {
  ...
  assert.match(intakeFormSource, /ref="sourceUrlInput"[\s\S]*v-model="form\.source_url"/)
