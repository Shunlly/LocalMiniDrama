...
test('首页空项目和下一步入口是中文，且空态按钮可点', () => {
  ...
  assert.match(filmListSource, /class="action-btn action-btn-new" :disabled="listWriteLocked" aria-label="新建项目"/)
  ...
  assert.match(filmListSource, /class="action-btn action-btn-import"[\s\S]*aria-label="导入项目包"/)
